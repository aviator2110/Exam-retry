...
+ Должна быть возможность взаимодействовать с сайтом с помощью событий.
  Например:
    + Можно удалить задачу нажав на кнопку удалить у задачи
    + Можно отфильтровать список задач нажав на кнопки `Done`, `Remainded` и `All`
...
+ У задачи, должны быть следующие поля:
    + (#) id - [уникальный идентификатор](https://stackoverflow.com/questions/3231459/how-can-i-create-unique-ids-with-javascript#) или [randomUUID()](https://developer.mozilla.org/en-US/docs/Web/API/Crypto/randomUUID)
...
+ Регулярные выражения
    ...
    + Название (реализовать одним регулярным выражением):
    ...
    + Подробное описание (реализовать одним регулярным выражением):
        + Должно быть минимум 1 слово
        + Не может полностью совпадать с названием (даже если вокруг будут whitespace)
